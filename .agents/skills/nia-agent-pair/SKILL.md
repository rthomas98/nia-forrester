...
2. Use separate worktrees and Manual permissions. Codex gpt-5.6-sol medium Standard owns Convex schema/functions, auth, entitlements, Stripe/Resend integration and shared API contracts. Fable claude-fable-5-1 medium owns Next.js presentation, design and accessibility.
