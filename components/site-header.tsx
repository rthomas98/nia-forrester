      ...
      >
          ...
          {visibleNavItems.map((item) => {
            ...
            return (
              <Link
                key={item.key}
                href={item.href}
                className="relative inline-flex min-h-11 min-w-11 items-center whitespace-nowrap px-[13px] py-2.5 font-sans text-sm font-semibold text-[var(--color-deep-plum)] transition duration-200 hover:-translate-y-0.5 hover:text-[var(--color-hot-magenta)] max-[800px]:rounded-xl max-[800px]:px-4 max-[800px]:py-3 max-[800px]:hover:translate-y-0 max-[800px]:hover:bg-white/70"
                onClick={() => setMobileMenuOpen(false)}
              >
                {item.label}
                {active && (
        ...
        <div className="flex flex-none items-center gap-3">
          {!authed ? (
            <Link
              href="/signin"
              className="inline-flex min-h-11 min-w-11 items-center whitespace-nowrap font-sans text-sm font-semibold text-[var(--color-deep-plum)] transition-colors duration-150 hover:text-[var(--color-hot-magenta)] max-[380px]:hidden"
            >
              Sign in
            </Link>
          ) : (
          ...
          <button
            type="button"
            className="hidden size-11 items-center justify-center rounded-full border border-transparent text-[var(--color-deep-plum)] transition hover:border-white/70 hover:bg-white/70 max-[800px]:flex"
